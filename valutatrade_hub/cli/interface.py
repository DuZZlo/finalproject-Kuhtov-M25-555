...
from valutatrade_hub.core.usecases import PortfolioManager, RateManager, SessionManager, TradeManager, UserManager
        ...
        try:
            ...
            if args.currency:
                ...
                if not filtered_pairs:
                    ...
                    print(f"Доступные валюты: {', '.join(sorted({p.split('_')[0] for p in pairs.keys()}))}")
                    return 1
