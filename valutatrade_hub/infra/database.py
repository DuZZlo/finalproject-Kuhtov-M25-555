...
class DatabaseManager(metaclass=type(SettingsLoader)):
    ...
    def find_one(self, collection: str, condition: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def find_all(self, collection: str, condition: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        data = self.read_collection(collection)
        results = []
